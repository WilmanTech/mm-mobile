Pod::Spec.new do |spec|
    spec.name                     = 'shared'
    spec.version                  = '0.1.0'
    spec.homepage                 = 'https://github.com/WilmanTech/mm-mobile'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    ...
    if !Dir.exist?('build/cocoapods/framework/MusicManagerShared.framework') || Dir.empty?('build/cocoapods/framework/MusicManagerShared.framework')
        ...
        Kotlin framework 'MusicManagerShared' doesn't exist yet, so a proper Xcode project can't be generated.
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'MusicManagerShared',
    }
